...
contract DeployUpgradeableVault is Script {
    ...
    function _printDeploymentSummary(
        ...
        console.log("  --constructor-args $(cast abi-encode \"constructor(address,address,address,address,uint256,uint256)\"");
        console.log("    %s %s %s", params.tokenAddress, params.sonicNFT, params.underlyingToken);
        console.log("    %s %s %s)", params.protocolTreasury, vm.toString(params.maturityTimestamp), vm.toString(params.vaultFreezeTimestamp));
        console.log("");

...
export const CONTRACTS = {
  ...
  57054: {
    ...
    SONIC_NFT: "0x399b835Ae853b514C5Ac6781AC6cF6355EAc538B", // Mock Sonic fNFT contract for testing
  },
  // Sonic Mainnet (Chain ID: 146)
  146: {
    VAULT_PROXY: "0xE2BB365a107441C1734a7aC08930dbEbb421249d", // Updated mainnet Vault address
    VS_TOKEN_PROXY: "0x2286bA4fcbb2eF06C4349fAF6B8970ece593f5DD", // Updated mainnet VS token address
    SONIC_NFT: "0xE1401171219FD2fD37c8C04a8A753B07706F3567", // TODO: Add actual mainnet address
  }
} as const;
